function [] = fmodel(session,channel)
...
for fold = 1:num_folds
    [profile,filename] = load_model(session,channel,fold);
    ...
    % center of gaussians
    profile.centers = get_centers(session,channel);
...
function centers = get_centers(session,channel)
